...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            reward_record = np.hstack((reward_record,current_reward))
            ...
            if episode % self.log_interval == 0:
                ...
                print(
                    "\n Scenario {} Algo {} Exp {} updates {}/{} episodes, total num timesteps {}/{}, FPS {}, time cost {}, return {}.\n".format(
        ...
        savemat('eposodic_return.mat', {'tensor': reward_record})
